...
export interface ControlPanelProps {
  ...
  /** Whether a forecast is currently loaded so playback can be enabled. */
  hasForecast: boolean;
  isPlaying: boolean;
  /** 0..1 normalized playback position. */
  playbackProgress: number;
  /** Forecast window in days, used to display "Day X" on the scrubber. */
  forecastDays: number;
  onPlayPause: () => void;
          ...
          >
            ...
            >
              ...
              <span style={{ color: "var(--text-muted)", fontSize: 11 }}>
                Day {(playbackProgress * Math.max(1, forecastDays)).toFixed(1)} /{" "}
                {forecastDays}
              </span>
            </div>
              ...
              <button
                ...
                style={{
                  ...
                  background: isPlaying
                    ? "rgba(83, 234, 253, 0.18)"
                    : "rgba(83, 234, 253, 0.08)",
                  color: "var(--cyan)",
                }}
              >
